from platetrack.dock_widgets import track_platelets
import napari
import zarr
from pathlib import Path

# example_root = Path('/Users/abigailmcgovern/Data/iterseg/sample_data/annotrack_example/')
example_root = Path('/Users/jni/data/FindingAndFollowing/annotrack_example')
...
dw, widget = napari_viewer.window.add_plugin_dock_widget(
        'platetrack', 'track_platelets'
        )
widget(napari_viewer, labels_layer, use_all_image_layers,
                     image_layer, sample_name, treatment_name, units,
                     save_file, save_mode,
